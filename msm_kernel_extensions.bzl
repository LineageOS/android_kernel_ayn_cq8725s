...
load("//vendor/ayn/kernel/arch/arm64/boot/dts/vendor:qcom/platform_map.bzl", _get_dtb_list = "get_dtb_list", _get_dtbo_list = "get_dtbo_list")
...
def get_dtstree(target):
    return "//vendor/ayn/kernel/arch/arm64/boot/dts/vendor:msm_dt"
